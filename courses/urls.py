...
urlpatterns = [
    ...
    path('course/all/', cache_page(60*5)(views.CourseListAllView.as_view()), name='course_all'),
    path('module/all/', cache_page(60*5)(views.ModuleListAllView.as_view()), name='module_all'),
    path('lesson/all/', cache_page(60*5)(views.LessonListAllView.as_view()), name='lesson_all'),
